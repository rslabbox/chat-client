...
// 导入所有 API 命令
use api::{greet, scan_plugins, mount_plugin, dispose_plugin, connect_plugin, disconnect_plugin, get_plugin_status, get_current_plugin, send_message_to_plugin, get_plugin_ui, handle_plugin_ui_event};
